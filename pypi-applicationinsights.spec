...
License  : MIT
Requires: pypi-applicationinsights-filemap = %{version}-%{release}
...
%package filemap
Summary: filemap components for the pypi-applicationinsights package.
Group: Default

%description filemap
filemap components for the pypi-applicationinsights package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652993002
...
%files filemap
%defattr(-,root,root,-)
/usr/share/clear/filemap/filemap-pypi-applicationinsights
