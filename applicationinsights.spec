...
License  : MIT
Requires: applicationinsights-license = %{version}-%{release}
...
%package license
Summary: license components for the applicationinsights package.
Group: Default

%description license
license components for the applicationinsights package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635703455
...
export MAKEFLAGS=%{?_smp_mflags}
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/applicationinsights
cp %{_builddir}/applicationinsights-0.11.10/LICENSE.txt %{buildroot}/usr/share/package-licenses/applicationinsights/64fd6ac4ad1ace96d613b150dcf16e3b25e65f7b
...
/usr/share/package-licenses/applicationinsights/64fd6ac4ad1ace96d613b150dcf16e3b25e65f7b
